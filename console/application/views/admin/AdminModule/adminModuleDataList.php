    ...
    <div class="col-md-12">
        <div class="panel panel-white">
            ...
            <div class="panel-body">
              <div class="row">         
              <?php 
            if($this->mcommon->getISUserPermission('AdminRole add and edit',$this->session->userdata('user_id'))){
              ?>
            ...
            <span class="pull-right"> 
              ...
              <!--
                ...
                -->
                  ...
                  ?>
              <?php 
                if($this->mcommon->getISUserPermission('AdminRole all details download excel',$this->session->userdata('user_id'))){
                  ?>
                ...
                if($this->mcommon->getISUserPermission('AdminRole all details download pdf',$this->session->userdata('user_id'))){
                  ?>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      jQuery("#dataTableList2").jqGrid({
        ...
        colModel:[
        <?php if($this->mcommon->getISUserPermission('AdminRole add and edit',$this->session->userdata('user_id'))){?>
          {label:'<?php echo lang('common_table_label_edit_operation');?>' ,name:'edit_menu_id',index:'edit_menu_id', width:75,resizable: false},
        <?php } if($this->mcommon->getISUserPermission('AdminRole delete',$this->session->userdata('user_id'))){?>
        ...
        <?php }?>
           {label:'<?php echo lang('mm_masters_adminmodule_table_label_menu_name');?>',name:'menu_name',index:'menu_name', width:150,resizable: false},
          {label:'<?php echo lang('mm_masters_adminmodule_table_label_menu_area');?>',name:'menu_area',index:'menu_area', width:150,resizable: false},
          {label:'<?php echo lang('mm_masters_adminmodule_table_label_menu_link');?>',name:'menu_link',index:'menu_link', width:150,resizable: false},
          {label:'<?php echo lang('mm_masters_adminmodule_table_label_menu_position');?>',name:'menu_position',index:'menu_position', width:150,resizable: false},
          {label:'<?php echo lang('mm_masters_adminmodule_table_label_createBy');?>',name:'first_name',index:'first_name', width:150,resizable: false},
          {label:'<?php echo lang('mm_masters_adminmodule_table_label_createOn');?>',name:'menu_createOn',index:'menu_createOn', width:150,resizable: false},    
          {label:'<?php echo lang('mm_masters_adminmodule_table_label_updateBy');?>',name:'firstname',index:'firstname', width:150,resizable: false},   
          {label:'<?php echo lang('mm_masters_adminmodule_table_label_updateon');?>',name:'menu_updateOn',index:'menu_updateOn', width:150, sortable:false,resizable: false} 
        ],
    ...
    //"openicon"  : "ui-icon-arrowreturn-1-e"
        ...
        subGridRowExpanded: function(subgrid_id, row_id) {
          ...
          jQuery("#"+subgrid_table_id).jqGrid({
            ...
            colModel:[
              {label:'<?php echo lang('common_table_label_edit_operation');?>' ,name:'edit_menu_id',index:'edit_menu_id', width:75,resizable: false},
               {label:'<?php echo lang('mm_masters_adminmodule_table_label_menu_name');?>',name:'menu_name',index:'menu_name', width:250,resizable: false},
              {label:'<?php echo lang('mm_masters_adminmodule_table_label_menu_link');?>',name:'menu_link',index:'menu_link', width:200,resizable: false},
              {label:'<?php echo lang('mm_masters_adminmodule_table_label_menu_position');?>',name:'menu_position',index:'menu_position', width:200,resizable: false},
              {label:'<?php echo lang('mm_masters_adminmodule_table_label_createBy');?>',name:'first_name',index:'first_name', width:150,resizable: false},
              {label:'<?php echo lang('mm_masters_adminmodule_table_label_createOn');?>',name:'menu_createOn',index:'menu_createOn', width:150,resizable: false},    
              {label:'<?php echo lang('mm_masters_adminmodule_table_label_updateBy');?>',name:'firstname',index:'firstname', width:150,resizable: false},   
              {label:'<?php echo lang('mm_masters_adminmodule_table_label_updateon');?>',name:'menu_updateOn',index:'menu_updateOn', width:150, sortable:false,resizable: false} 
