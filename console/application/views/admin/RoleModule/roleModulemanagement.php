              ...
              <div class="row">
                ...
                <div class="col-sm-3 col-xs-3">
                  <div class="form-group <?PHP if(form_error('name')){ echo 'has-error';} ?>">
                    <label for="exampleInputEmail1"><?php echo lang('mm_masters_rolemodule_name');?><span class="text-danger">*</span></label>
                    <input type="text" class="form-control" placeholder="<?php echo lang('mm_masters_rolemodule_name');?>" id="name" name="name" value="<?php echo $name ;?>" autocomplete="off">
                ...
                <div class="col-sm-6 col-xs-6">
                  <div class="form-group <?PHP if(form_error('description')){ echo 'has-error';} ?>">
                    <label for="exampleInputEmail1"><?php echo lang('mm_masters_rolemodule_description');?><span class="text-danger">*</span></label>
                    <textarea class="form-control" placeholder="<?php echo lang('mm_masters_rolemodule_description');?>" id="description" name="description" rows="3"><?php echo $description;?></textarea><?PHP if(form_error('description')){ echo '<span class="help-block">'.form_error('description').'</span>';} ?>
                  </div>
                </div>
