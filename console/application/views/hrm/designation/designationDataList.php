        ...
        <div class="row m-b-10">
          <div class="col-sm-12">          
            <span class="pull-left">
              <a href="<?php echo base_url().$add_button_url;?>" class="btn btn-success waves-effect waves-light m-r-10 pull-right" ><?php echo lang('mm_Hrm_designation_manage_form_add_button_name');?></a>
            </span>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      jQuery("#dataTableList2").jqGrid({
        ...
        colModel:[
          {label:'<?php echo lang('mm_Hrm_designation_table_label_operation');?>' ,name:'designation_id',index:'designation_id', width:120},
           {label:'<?php echo lang('mm_Hrm_designation_table_label_designation_name');?>',name:'designation_name',index:'designation_name', width:345},
          {label:'<?php echo lang('mm_Hrm_designation_table_label_designation_abbr');?>',name:'designation_abbr',index:'designation_abbr', width:250},
          {label:'<?php echo lang('mm_Hrm_designation_table_label_createBy');?>',name:'first_name',index:'first_name', width:100,},
          {label:'<?php echo lang('mm_Hrm_designation_table_label_createOn');?>',name:'designation_createOn',index:'designation_createOn', width:150},    
          {label:'<?php echo lang('mm_Hrm_designation_table_label_updateBy');?>',name:'firstname',index:'firstname', width:100},   
          {label:'<?php echo lang('mm_Hrm_designation_table_label_updateon');?>',name:'designation_updateOn',index:'designation_updateOn', width:150, sortable:false} 
        ],
    ...
    $("#pdf").on("click", function(){
        $("#dataTableList2").jqGrid("exportToPdf",{
          title: '<?php echo lang('mm_Hrm_designation_pdfTitle');?>',
