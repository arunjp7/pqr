        ...
        <?php echo form_open_multipart($form_url); ?>
          <div class="row">
            <div class="col-sm-3 col-xs-3">
              <div class="form-group <?PHP if(form_error('welder_name')){ echo 'has-error';} ?>">
                <label for="exampleInputEmail1"><?php echo lang('mm_masters_welder_name');?><span class="text-danger">*</span></label>
                <input type="text" class="form-control" placeholder="<?php echo lang('mm_masters_welder_name');?>" id="welder_name" name="welder_name" value="<?php echo $welder_name ;?>" autocomplete="off">
                <?PHP if(form_error('welder_name')){ echo '<span class="help-block">'.form_error('welder_name').'</span>';} ?>
              </div>
            </div>
          </div>              
