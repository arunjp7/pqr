              ...
              <div class="row">
                <!--<div class="col-sm-0 col-xs-0">
                  <div class="form-group <?PHP if(form_error('welderPass_attProcess_name')){ echo 'has-error';} ?>">
                    <input type="hidden" class="form-control" placeholder="<?php echo lang('mm_masters_batch_Modal_welder_pass_attProcess_name');?>" id="welderPass_attProcess_name" name="welderPass_attProcess_name" value="<?php echo $welderPass_attProcess_name ;?>" autocomplete="off">
              ...
              <div class="row">
                ...
                <div class="col-sm-12 col-xs-12">
                  <div class="form-group <?PHP if(form_error('welderPass_attProcessType_value')){ echo 'has-error';} ?>">
                    <input type="hidden" class="form-control" placeholder="<?php echo lang('mm_masters_batch_Modal_welder_pass_attProcessType_name');?>" id="welderPass_attProcessType_name" name="welderPass_attProcessType_name" value="<?php echo $welderPass_attProcessType_name ;?>" autocomplete="off">
              ...
              <div class="row">
                ...
                <div class="col-sm-12 col-xs-12">
                  <div class="form-group <?PHP if(form_error('welderPass_attPosition_value')){ echo 'has-error';} ?>">
                    <input type="hidden" class="form-control" placeholder="<?php echo lang('mm_masters_batch_Modal_welder_pass_attPosition_name');?>" id="welderPass_attPosition_name" name="welderPass_attPosition_name" value="<?php echo $welderPass_attPosition_name ;?>" autocomplete="off">
              ...
              <div class="row">
                ...
                <div class="col-sm-12 col-xs-12">
                  <div class="form-group <?PHP if(form_error('welderPass_attPositionQul_value')){ echo 'has-error';} ?>">
                    <input type="hidden" class="form-control" placeholder="<?php echo lang('mm_masters_batch_Modal_welder_pass_attPositionQul_name');?>" id="welderPass_attPositionQul_name" name="welderPass_attPositionQul_name" value="<?php echo $welderPass_attPositionQul_name ;?>" autocomplete="off">
              ...
              <div class="row">
                ...
                <div class="col-sm-12 col-xs-12">
                  <div class="form-group <?PHP if(form_error('welderPass_attJointType_value')){ echo 'has-error';} ?>">
                    <input type="hidden" class="form-control" placeholder="<?php echo lang('mm_masters_batch_Modal_welder_pass_attJointType_name');?>" id="welderPass_attJointType_name" name="welderPass_attJointType_name" value="<?php echo $welderPass_attJointType_name ;?>" autocomplete="off">
              ...
              <div class="row">
                ...
                <div class="col-sm-12 col-xs-12">
                  <div class="form-group <?PHP if(form_error('welderPass_attTestThickness_value')){ echo 'has-error';} ?>">
                    <input type="hidden" class="form-control" placeholder="<?php echo lang('mm_masters_batch_Modal_welder_pass_attTestThickness_name');?>" id="welderPass_attTestThickness_name" name="welderPass_attTestThickness_name" value="<?php echo $welderPass_attTestThickness_name ;?>" autocomplete="off">
              ...
              <div class="row">
                ...
                <div class="col-sm-12 col-xs-12">
                  <div class="form-group <?PHP if(form_error('welderPass_attTestDia_value')){ echo 'has-error';} ?>">
                    <input type="hidden" class="form-control" placeholder="<?php echo lang('mm_masters_batch_Modal_welder_pass_attTestDia_name');?>" id="welderPass_attTestDia_name" name="welderPass_attTestDia_name" value="<?php echo $welderPass_attTestDia_name ;?>" autocomplete="off">
              ...
              <div class="row">
                ...
                <div class="col-sm-12 col-xs-12">
                  <div class="form-group <?PHP if(form_error('welderPass_attPGrpNo_value')){ echo 'has-error';} ?>">
                    <input type="hidden" class="form-control" placeholder="<?php echo lang('mm_masters_batch_Modal_welder_pass_attPGrpNo_name');?>" id="welderPass_attPGrpNo_name" name="welderPass_attPGrpNo_name" value="<?php echo $welderPass_attPGrpNo_name ;?>" autocomplete="off">
              ...
              <div class="row">
                ...
                <div class="col-sm-12 col-xs-12">
                  <div class="form-group <?PHP if(form_error('welderPass_attElectrodeClass_value')){ echo 'has-error';} ?>">
                    <input type="hidden" class="form-control" placeholder="<?php echo lang('mm_masters_batch_Modal_welder_pass_attElectrodeClass_name');?>" id="welderPass_attElectrodeClass_name" name="welderPass_attElectrodeClass_name" value="<?php echo $welderPass_attElectrodeClass_name ;?>" autocomplete="off">
              ...
              <div class="row">
                ...
                <div class="col-sm-12 col-xs-12">
                  <div class="form-group <?PHP if(form_error('welderPass_attFNo_value')){ echo 'has-error';} ?>">
                    <input type="hidden" class="form-control" placeholder="<?php echo lang('mm_masters_batch_Modal_welder_pass_attFNo_name');?>" id="welderPass_attFNo_name" name="welderPass_attFNo_name" value="<?php echo $welderPass_attFNo_name ;?>" autocomplete="off">
              ...
              <div class="row">
                ...
                <div class="col-sm-12 col-xs-12">
                  <div class="form-group <?PHP if(form_error('welderPass_attBacking_value')){ echo 'has-error';} ?>">
                    <input type="hidden" class="form-control" placeholder="<?php echo lang('mm_masters_batch_Modal_welder_pass_attBacking_name');?>" id="welderPass_attBacking_name" name="welderPass_attBacking_name" value="<?php echo $welderPass_attBacking_name ;?>" autocomplete="off">
