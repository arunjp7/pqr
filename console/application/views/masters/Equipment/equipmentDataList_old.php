      ...
      jQuery("#dataTableList2").jqGrid({
        ...
        //jQuery(this).css({'width': '1200px !important'});
                ...
                /*var ret;
                  ...
                  ret = jQuery("#dataTableList2").jqGrid('getRowData');

                  if(ret.equipment_calibration_report_number == "MTE-CC-S22736"){
                                      console.log(ret);
jQuery("#dataTableList2").addClass('dfdsgfsgfg');

                    jQuery("#dataTableList2").jqGrid('setRowData',ret.equipment_calibration_report_number,{note:"<font color='red'>Row 13 is updated!</font>"})
                  }
  */
                var ids = jQuery("#dataTableList2").jqGrid('getDataIDs');
                for (var i = 0; i < ids.length; i++) 
                {
                    var rowId = ids[i];
                    var rowData = jQuery('#dataTableList2').jqGrid ('getRowData', rowId);
        ...
        colModel:[
          {label:'<?php echo lang('mm_masters_equipment_table_label_equipment_SNo');?>' ,name:'category_name',index:'category_name', width:110,resizable: false},
          {label:'<?php echo lang('mm_masters_equipment_table_label_operation');?>' ,name:'equipment_id',index:'equipment_id', width:110,resizable: false},
           {label:'<?php echo lang('mm_masters_equipment_table_label_equipment_test_equipment');?>',name:'equipment_test_equipment',index:'equipment_test_equipment', width:100,resizable: false},
          {label:'<?php echo lang('mm_masters_equipment_table_label_equipment_manufacturer');?>',name:'equipment_manufacturer',index:'equipment_manufacturer', width:100,resizable: false},
          {label:'<?php echo lang('mm_masters_equipment_table_label_equipment_serial_number');?>',name:'equipment_serial_number',index:'equipment_serial_number', width:100,resizable: false},
          {label:'<?php echo lang('mm_masters_equipment_table_label_equipment_asset_tag_number');?>',name:'equipment_asset_tag_number',index:'equipment_asset_tag_number', width:100,resizable: false},
          {label:'<?php echo lang('mm_masters_equipment_table_label_equipment_calibration_report_number');?>',name:'equipment_calibration_report_number',index:'equipment_calibration_report_number', width:150,resizable: false},
          {label:'<?php echo lang('mm_masters_equipment_table_label_equipment_recommended_rang');?>',name:'equipment_recommended_range',index:'equipment_recommended_range', width:100,resizable: false},
          {label:'<?php echo lang('mm_masters_equipment_table_label_equipment_range');?>',name:'equipment_range',index:'equipment_range', width:100,resizable: false},
          {label:'<?php echo lang('mm_masters_equipment_table_label_equipment_least_count');?>',name:'equipment_least_count',index:'equipment_least_count', width:75,resizable: false},
          {label:'<?php echo lang('mm_masters_equipment_table_label_equipment_purpose');?>',name:'equipment_purpose',index:'equipment_purpose', width:75,resizable: false},
          {label:'<?php echo lang('mm_masters_equipment_table_label_equipment_acceptance_criteria');?>',name:'equipment_acceptance_criteria',index:'equipment_acceptance_criteria', width:150,resizable: false},
          {label:'<?php echo lang('mm_masters_equipment_table_label_equipment_calibrated_by');?>',name:'equipment_calibration_by',index:'equipment_calibration_by', width:50,resizable: false},
          {label:'<?php echo lang('mm_masters_equipment_table_label_equipment_last_calibrated_date');?>',name:'equipment_calibration_date',index:'equipment_calibration_date', width:125,resizable: false},
          {label:'<?php echo lang('mm_masters_equipment_table_label_equipment_calibrated_due_date');?>',name:'equipment_calibration_due_date',index:'equipment_calibration_due_date', width:125,resizable: false},
          {label:'<?php echo lang('mm_masters_equipment_table_label_equipment_calibration_frequency_monts');?>',name:'equipment_calibration_frequency',index:'equipment_calibration_frequency', width:150,resizable: false},
          {label:'<?php echo lang('mm_masters_equipment_table_label_equipment_alert_frequency_days');?>',name:'equipment_alert_frequency',index:'equipment_alert_frequency', width:150,resizable: false},
          {label:'<?php echo lang('mm_masters_equipment_table_label_equipment_remarks');?>',name:'equipment_remarks',index:'equipment_remarks', width:100,resizable: false},
          {label:'<?php echo lang('mm_masters_equipment_table_label_equipment_status');?>',name:'status_name',index:'status_name', width:75,resizable: false},
          {label:'<?php echo lang('mm_masters_equipment_table_label_createBy');?>',name:'first_name',index:'first_name', width:150,resizable: false},
          {label:'<?php echo lang('mm_masters_equipment_table_label_createOn');?>',name:'equipment_createOn',index:'equipment_createOn', width:150,resizable: false},    
          {label:'<?php echo lang('mm_masters_equipment_table_label_updateBy');?>',name:'firstname',index:'firstname', width:150,resizable: false},   
          {label:'<?php echo lang('mm_masters_equipment_table_label_updateon');?>',name:'equipment_updateOn',index:'equipment_updateOn', width:150, sortable:false,resizable: false} 
        ],
    ...
    //"openicon"  : "ui-icon-arrowreturn-1-e"
        ...
        subGridRowExpanded: function(subgrid_id, row_id) {
          ...
          jQuery("#"+subgrid_table_id).jqGrid({
            ...
            colModel:[
              {label:'<?php echo lang('mm_masters_equipment_calibration_Modal_table_label_operation');?>' ,name:'equipmentID',index:'equipmentID', width:110,resizable: false},
              ...
              {label:'<?php echo lang('mm_masters_equipment_calibration_Modal_table_label_temperatureData');?>',name:'scalibrationAttachment',index:'calibrationAttachment', width:100,resizable: false},
