...
<div class="row" id="rowssid_<?php echo $in;?>">
  <div class="col-sm-2 col-xs-2">
    <div class="form-group">
      <input type="hidden" value="" name="equipment_additional_id[]" />

      <a href="javascript:void(0);" onclick="getConfirmdeleteAdditional(<?php echo $in;?>,'')" class="btn btn-danger"  title="<?php echo lang('helper_common_delete_label');?>"><i class="glyphicon glyphicon-trash"></i></a>
    </div>
  </div>
