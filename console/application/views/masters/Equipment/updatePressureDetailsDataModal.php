...
if(isset($value) && !empty($value))
{
  ...
  {  
    $equipment_pressure_id[]            =  $row->equipment_pressure_id;
    $equipment_pressure_input1[]        =  $row->equipment_pressure_input1;
    $equipment_pressure_output1[]       =  $row->equipment_pressure_output1;
    $equipment_pressure_error1[]        =  $row->equipment_pressure_error1;
    $equipment_pressure_input2[]        =  $row->equipment_pressure_input2;
    $equipment_pressure_output2[]       =  $row->equipment_pressure_output2;
    $equipment_pressure_error2[]        =  $row->equipment_pressure_error2;
...
else
{
  ...
  $equipment_pressure_id              =  $this->input->post('equipment_pressure_id');
  $equipment_pressure_input1          =  $this->input->post('equipment_pressure_input1');
  $equipment_pressure_output1         =  $this->input->post('equipment_pressure_output1');
  $equipment_pressure_error1          =  $this->input->post('equipment_pressure_error1');
  $equipment_pressure_input2          =  $this->input->post('equipment_pressure_input2');
  $equipment_pressure_output2         =  $this->input->post('equipment_pressure_output2');
  $equipment_pressure_error2          =  $this->input->post('equipment_pressure_error2');
...
<div class="modal-content">
  ...
  <div class="modal-body">
    ...
    <form ng-app="form-example" method="post" id="ajaxModelForm1" enctype="multipart/form-data" action="javascript:" ui-jp="parsley">
      ...
      <div class="row" >
        <div class="col-sm-4"><h4 class="modal-title"><?php echo lang('mm_masters_equipment_Modal_Pressure_Recorder_title');?></h4></div>
        <div class="col-sm-8">
      ...
      <div class="row">
        <div class="col-sm-1 col-xs-1">
          <div class="form-group m-b-0">
            <label for="exampleInputEmail1"><?php echo lang('mm_masters_equipment_Pressure_delate');?></label>
          </div>
        </div>
        <div class="col-sm-11 col-xs-11">
          <div class="row">
            <div class="col-sm-2 col-xs-2">
              <div class="form-group m-b-0">
                <label for="exampleInputEmail1"><?php echo lang('mm_masters_equipment_calibration_Modal_Pressure_input');?></label>
              </div>
            </div>
            <div class="col-sm-2 col-xs-2">
              <div class="form-group m-b-0">
                <label for="exampleInputEmail1"><?php echo lang('mm_masters_equipment_calibration_Modal_Pressure_output');?></label>
              </div>
            </div>
            <div class="col-sm-2 col-xs-2">
              <div class="form-group m-b-0">
                <label for="exampleInputEmail1"><?php echo lang('mm_masters_equipment_calibration_Modal_Pressure_error');?></label>
              </div>
            </div>                
            <div class="col-sm-2 col-xs-2">
              <div class="form-group m-b-0">
          ...
          <div class="row" id="rowssid_<?php echo $in;?>">
            <div class="col-sm-1 col-xs-1">
              <div class="form-group">
                ...
                <a href="javascript:void(0);" onclick="getConfirmdeletePressure(<?php echo $in;?>,'<?php echo base_url().'masters/Equipment/getupdateEquipmentPressureDetailsModal/'.$equipment_pressure_id[$in];?>')" class="btn btn-danger"  title="<?php echo lang('helper_common_delete_label');?>"><i class="glyphicon glyphicon-trash"></i></a>
              </div>
            </div>
...
jQuery(document).ready(function() 
  ...
  function addNewAdditional()
  {
    ...
    $.ajax({
      type: "GET",
      url: "<?php echo site_url('masters/Equipment/getPressureContent'); ?>", 
      data: { i:row},
      dataType:"html",
...
function getConfirmdeletePressure(inv, url)
    {
      if(arguments[0] != null)
      {
        swal({
