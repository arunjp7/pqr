...
if(isset($value) && !empty($value))
{
  ...
  {  
    $attachement_welder_id                =  $row->attachement_welder_id;
    $attachement_type_name                =  $row->attachement_type_name;
    $attachement_file_name                =  $row->attachement_file_name;   
    $old_attachement_file_name            =  $row->attachement_file_name;   
  }
}
else
{
  $attachement_welder_id                  =  $this->input->post('attachement_welder_id');
  $attachement_type_name                  =  $this->input->post('attachement_type_name');
  $attachement_file_name                  =  $this->input->post('attachement_file_name');
  $old_attachement_file_name              =  $this->input->post('old_attachement_file_name');
}
$ci =&get_instance();
...
<div class="modal-content">
  <div class="modal-header panel-heading clearfix">
    <h4 class="modal-title" id="myLargeModalLabel"><?php echo lang('mm_masters_welder_Modal_Attachement_title');?></h4>
  </div>
    ...
    <div class="modal-body">
      ...
      <div class="row">
        <div class="col-sm-4 col-xs-4">
          ...
          <div class="row">
            <div class="col-sm-12 col-xs-12">
              <div class="form-group <?PHP if(form_error('attachement_type_name')){ echo 'has-error';} ?>">
                <label for="exampleInputEmail1"><?php echo lang('mm_masters_welder_Modal_attachement_type_name');?></label>
                <input type="text" class="form-control" placeholder="<?php echo lang('mm_masters_welder_Modal_attachement_type_name');?>" id="attachement_type_name" name="attachement_type_name" value="<?php echo $attachement_type_name ;?>" autocomplete="off">
          ...
          <div class="row">
            <div class="col-sm-12 col-xs-12">
              ...
              <label for="exampleInputEmail1"><?php echo lang('mm_masters_welder_Modal_attachement_file_name');?> <?php echo lang('mm_common_logo_size_label_500');?> </label>
                <div class="fileinput fileinput-new input-group" data-provides="fileinput">
                  ...
                  </span> <a href="#" class="input-group-addon btn btn-default fileinput-exists" data-dismiss="fileinput"><?php echo lang('mm_masters_welder_Modal_attachement_file_name');?></a>
                </div>
        ...
        <div class="col-sm-7 col-xs-7">
          <div class="row">
            <div class="col-sm-12 col-xs-12">
            <h5 class="box-title m-b-0"><b><?php echo lang('mm_masters_welder_Modal_attachement_instructions_title');?></b></h5>
            <p class="text-muted"><?php echo lang('mm_masters_welder_Modal_attachement_instructions_text1');?></p>
            <p class="text-muted"><?php echo lang('mm_masters_welder_Modal_attachement_instructions_text2');?></p>
            <p class="text-muted"><?php echo lang('mm_masters_welder_Modal_attachement_instructions_text3');?></p>
            <p class="text-muted"><?php echo lang('mm_masters_welder_Modal_attachement_instructions_text4');?></p>
          </div>
        </div>
      </div>
      ...
      <div class="text-center">
        ...
        <input type="hidden" name="attachement_welder_id" value="<?php echo $attachement_welder_id;?>">
        <input type="hidden" name="old_attachement_file_name" value="<?php echo $old_attachement_file_name;?>" />
  ...
  <div class="row">
        <div class="col-sm-12">
          <div class="white-box">
            <h3 class="box-title m-b-0"><?php echo lang('mm_masters_welder_Modal_attachement_datatable_title');?></h3>
            <table id="myTable" class="table table-striped">
              <thead>
                <tr>
                  <th><?php echo lang('mm_masters_welder_Modal_attachement_datatable_sno');?></th>
                  <th><?php echo lang('mm_masters_welder_Modal_attachement_datatable_delete');?></th>
                  <th><?php echo lang('mm_masters_welder_Modal_attachement_datatable_filename');?></th>
                  <th><?php echo lang('mm_masters_welder_Modal_attachement_datatable_type');?></th>
                  <th><?php echo lang('mm_masters_welder_Modal_attachement_datatable_filesize');?></th>
                  <th><?php echo lang('mm_masters_welder_table_label_updateBy');?></th>
                  <th><?php echo lang('mm_masters_welder_table_label_updateon');?></th>
                </tr>
              </thead>
                  ...
                  foreach($datatablevalue as $row){ 
                    ?>
                      <tr>
                        ...
                        <td><?php echo get_buttons_new_only_Delete1($row['attachement_welder_id'],'masters/Welder/getupdateAttachementModal');?></td>
                        <td>
                        ...
                        <?php echo (str_replace('application/','', $row['attachement_file_type']) == 'pdf') ? '<i class="fa fa-file-pdf-o"  aria-hidden="true"></i>' : '<i class="fa fa-picture-o" aria-hidden="true"></i>' ;?>&nbsp;&nbsp;<?php echo str_replace('attachement/','', $row['attachement_file_name']);?></a></td>
