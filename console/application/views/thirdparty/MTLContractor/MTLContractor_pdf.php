    ...
    <td>
		<table width="100%" height="600" cellspacing="0" cellpadding="10" border="0" rules="row" class="table">
          <tr class="bgcolorgray">
            ...
            <th width="60%" class="bo-t bo-r bo-l"><strong><?php echo lang('mm_Hrm_MTLContractor_name');?></strong></th>
            <th width="31%" class="bo-t bo-r bo-l"><strong><?php echo lang('mm_Hrm_MTLContractor_abbr');?></strong></th>
          </tr>
          <?php
			if(isset($pdf_Details) && !empty($pdf_Details))
			{
		        ...
		        foreach($pdf_Details->result() as $pdfDetail)
		        {
		      		...
		      		<tr>
			            ...
			            <td width="60%" class="bo-t bo-r bo-l"><?php echo $pdfDetail->mtlContractor_name ;?></td>
			            <td width="31%" class="bo-t bo-r bo-l"><?php echo $pdfDetail->mtlContractor_abbr ;?></td>
		            </tr>
		      		<?php
		        }
		    }
