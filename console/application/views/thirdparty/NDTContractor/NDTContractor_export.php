...
if(isset($export_Details) && !empty($export_Details))
{
    ...
    <table width="100%" cellspacing="10" cellpadding="10" rules="all" border="1px"  >
        ...
        <tr>
            ...
            <th style="width:60% !important"><?php echo lang('mm_Hrm_NDTContractor_name');?></th>
            <th style="width:35% !important"><?php echo lang('mm_Hrm_NDTContractor_abbr');?></th>
        </tr>
        <?php 
        $i='1';
        foreach($export_Details->result() as $exportDetail)
        {
           ?>
            <tr>
                ...
                <td widt="60%" style="width:5% !important"><?php echo $exportDetail->ndtContractor_name ;?></td>
                <td widt="35%" style="width:10% !important"><?php echo $exportDetail->ndtContractor_abbr ;?></td>
            </tr>
           <?php
        }
        ?>
